...
class Form
{
    ...
    */
    ...
    protected function getJsCode()
    {
        ...
        $this->js_code .= '    if(top != self&&typeof location.ancestorOrigins!="undefined"){if(location.ancestorOrigins[0]!=="https://preview.codecanyon.net"&&!$("#drag-and-drop-preview")[0]){$("form").on("submit",function(e){e.preventDefault();console.log("not allowed");return false;});}}' . "\n";
